...
trait Header_Components {
	...
	public static function tutor_multi_column_dropdown() {
		...
		<div class="tutor-header-profile-content">
			<div class="tutor-header-profile-content-text"><?php esc_html_e( 'Hola', 'tutorstarter' ); ?></div>
				...
				<?php if ( ! defined( 'TDC_VERSION' ) ) : ?>
					<div class="tutor-submenu-login-section-instructor">
						...
						<div class="tutor-submenu-login-content">
							<div class="tutor-submenu-login-profile" style="margin-top: 10px;"><?php wp_kses_post( _e( 'Crea un<br />Nuevo Curso', 'tutorstarter' ) ) ?></div>
							<p class="tutor-mt-10 tutor-font-size-14" style="line-height: 1.5em; font-size:14px; margin-top:10px;"><?php wp_kses_post( _e( 'Comienza con temas,<br />lecciones y más', 'tutorstarter' ) ); ?></p>
						</div>
			...
			<?php else : ?>
				<?php if ( ! defined( 'TDC_VERSION' ) ) : ?>
					<div class="tutor-submenu-login-section">
						...
						<div class="tutor-submenu-login-content">
							<div class="tutor-submenu-login-profile" style="margin-top: 10px;"><?php wp_kses_post( _e( 'Empecemos Aprendiendo', 'tutorstarter' ) ); ?></div>
							<p class="tutor-mt-10 tutor-font-size-14" style="line-height: 1.5em; font-size:14px; margin-top:10px;"><?php wp_kses_post( _e( 'Explora cursos que<br />desbloquearán tu potencial.', 'tutorstarter' ) ); ?></p>
						</div>
						<div class="tutor-submenu-login-btn">
							<a class="tutor-submenu-login" href="<?php echo esc_url( tutor_utils()->course_archive_page_url() ) ?>">
							<span class="dashicons dashicons-arrow-right-alt2" style="font-weight: bold;"></span></a>
						</div>
					</div>
				<?php else : ?>
					<div class="tutor-submenu-login-section-instructor">
	...
	public static function filtered_nav() {
		...
		$common_navs     = array(
			'settings' => array(
				'title' => __( 'Ajustes', 'tutorstarter' ),
				'icon'  => 'tutor-icon-settings-filled',
			),
			'logout'   => array(
				'title' => __( 'Cerrar Sesión', 'tutorstarter' ),
	...
	public static function default_menus() {
		return array(
			'index'            => array(
				'title' => __( 'Escritorio', 'tutorstarter' ),
				'icon'  => 'tutor-icon-dashboard-filled',
			),
			'my-profile'       => array(
				'title' => __( 'Mi Perfil', 'tutorstarter' ),
				'icon'  => 'tutor-icon-man-user-filled',
			),
			'enrolled-courses' => array(
				'title' => __( 'Cursos Inscritos', 'tutorstarter' ),
				'icon'  => 'tutor-icon-college-graduation-filled',
			),
			'wishlist'         => array(
				'title' => __( 'Lista de deseos', 'tutorstarter' ),
				'icon'  => 'tutor-icon-fav-full-filled',
			),
			'reviews'          => array(
				'title' => __( 'Reseñas', 'tutorstarter' ),
				'icon'  => 'tutor-icon-star-full-filled',
			),
			'my-quiz-attempts' => array(
				'title' => __( 'Mis intentos de cuestionario', 'tutorstarter' ),
				'icon'  => 'tutor-icon-quiz-attempt-filled',
			),
			'purchase_history' => array(
				'title' => __( 'Historial de pedidos', 'tutorstarter' ),
				'icon'  => 'tutor-icon-cart-filled',
			),
			'question-answer'  => array(
				'title' => __( 'Preguntas & Respuestas', 'tutorstarter' ),
